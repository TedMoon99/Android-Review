...
class CustomAdapter(
    private val dataList: ArrayList<UnifiedAnimalData>,
    ...
    inner class CustomViewHolder(
        ...
        fun clickListener(
            ...
            viewModel.apply {
                updateClickedIndex(animalIdx)
                updateClickedAnimalType(animalType)
            }
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            holder.clickListener(
                viewModel,
                fragmentManager,
                dataList[position].animalIdx,
                dataList[position].animalType.num
            )
        }
    }
}